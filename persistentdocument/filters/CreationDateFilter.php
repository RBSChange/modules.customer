<?php
class customer_CreationDateFilter extends f_persistentdocument_DocumentFilterImpl
{
	...
	public function getQuery()
	{
		...
		return customer_CustomerService::getInstance()->createQuery()->add(Restrictions::gt('creationdate', $date));
	}
